...
AC-301 начинает этап 3 / M3 — управление портфелем продуктов и кандидатами в повторно используемые модули как инвестициями, а не как простым списком репозиториев.
